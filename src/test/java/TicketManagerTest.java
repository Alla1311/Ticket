...
public class TicketManagerTest {
    ...
    private Ticket ticket1 = new Ticket(1, "MSK", "NN", 900, 400);
    private Ticket ticket2 = new Ticket(2, "Samara", "SPB", 1000, 900);
    private Ticket ticket3 = new Ticket(3, "MSK", "NN", 800, 420);
    private Ticket ticket4 = new Ticket(4, "NN", "Kazan", 1500, 450);
    ...
    public void ticketToTest() {
        ...
        manager.save(ticket5);
        Ticket[] expected = {};
        Ticket[] actual = manager.findAll("NN", "MSK");
    ...
    public void ticketMaxPriceTest() {
        ...
        Ticket[] actual = manager.findAll("NN", "Kazan");
